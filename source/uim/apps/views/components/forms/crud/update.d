...
/* 
auto editheader(T:DEntity)(string path, T entity, DAPPPanes panes, STRINGAA reqParameters) {
  return 
    BS5CardHeader( 
...
auto editbody_(T:DEntity)(string path, T entity, DAPPPanes panes, STRINGAA reqParameters) {
  return 
    BS5CardBody(
      BS5Row.col(["col-12"], 
