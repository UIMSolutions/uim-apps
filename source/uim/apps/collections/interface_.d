 ...
 */
interface IAPPCollection { //} extends Iterator, JsonSerializable
    /**
     ...
     * @return this
     */
    O each(this O)(callable callback);
     ...
     * @return self
     */
    // IAPPCollection filter(?callable callback = null);
     ...
     */
    // IAPPCollection reject(callable callback);
     ...
     * @return self
     */
    // IAPPCollection map(callable callback);
     ...
     * of doing that.
     */
    IAPPCollection extract(string path);
     ...
     */
    // public function max(string path, int sort = \SORT_NUMERIC);
     ...
     */
    // public function min(string path, int sort = \SORT_NUMERIC);
     ...
     */
    // public function avg(string path = null);
     ...
     * @return float|int|null
     */
    // public function median(string path = null);
     ...
     * SORT_NUMERIC or SORT_NATURAL
     */
    // IAPPCollection sortBy(string path, int order = SORT_DESC, int sort = SORT_NUMERIC);
     ...
     * @return self
     */
    IAPPCollection groupBy(string path);
     ...
     */
    IAPPCollection indexBy(string path);
     ...
     * @return self
     */
    IAPPCollection countBy(string path);
     ...
     * @return float|int
     */
    // public function sumOf(string path = null);
     ...
     */
    IAPPCollection shuffle();

    /**
     * Returns a new collection with maximum size random elements
     * from this collection
     *
     * @param size_t length the maximum number of elements to randomly
     * take from this collection
     * @return self
     */
    IAPPCollection sample(size_t length = 10);
     ...
     *
     * @param size_t length the maximum number of elements to take from
     * this collection
     * @param int offset A positional offset from where to take the elements
     * @return self
     */
    IAPPCollection take(size_t length = 1, int offset = 0);
     ...
     * ```
     *
     * @param size_t length The number of elements at the end of the collection
     * @return self
     */
    IAPPCollection takeLast(size_t length);

    /**
     * Returns a new collection that will skip the specified amount of elements
     * at the beginning of the iteration.
     *
     * @param size_t length The number of elements to skip.
     * @return self
     */
    IAPPCollection skip(size_t length);
     ...
     */
    // IAPPCollection match(array conditions);
     ...
     * @return self
     */
    // IAPPCollection appendItem(item, key = null);
     ...
     * @return self
     */
    // IAPPCollection prependItem(item, key = null);
     ...
     * @return self
     */
    IAPPCollection combine(string keyPath, string valuePath, string groupPath = null);
     ...
     * @return self
     */
    IAPPCollection nest(string idPath, string parentPath, string nestingKey = "children");
     ...
     */
    // IAPPCollection insert(string path, values);
     ...
     * @return self
     */
    IAPPCollection compile(bool keepKeys = true);
     ...
     */
    IAPPCollection listNested(string order = "desc", string nestingKey = "children");
     ...
     * and the value the condition against with each element will be matched.
     */
    // IAPPCollection stopWhen(condition);
     ...
     * @return self
     */
    // IAPPCollection unfold(?callable callback = null);
     ...
     * @return self
     */
    //IAPPCollection through(callable callback);
     ...
     * @return self
     */
    // IAPPCollection zip(iterable items);
     ...
     * @return self
     */
    // IAPPCollection zipWith(iterable items, callback);
     ...
     * @return self
     */
    IAPPCollection chunk(int chunkSize);
     ...
     * @return self
     */
    IAPPCollection chunkWithKeys(int chunkSize, bool keepKeys = true);
     ...
     * @return self
     */
    // IAPPCollection cartesianProduct(this O)(?callable operation = null, ?callable filter = null): 
}
